...
function QuickActionCard({ title, description, route }) {
  return (
    <Link
      ...
      to={route}
    >
      <Card className="flex h-full flex-col transition-all duration-150 group-hover:border-[var(--color-brand-primary)] group-hover:bg-[var(--color-surface-2)] motion-safe:group-hover:-translate-y-0.5 motion-reduce:transition-none">
